...
namespace Game.Components.GridSystem.PathFindingSystem
{
    public class PathFinding : MonoBehaviour
    {
        ...
        public List<Node> FindPath(Vector3 startPosition, Vector3 targetPosition, IGridObject targetGridObject = null)
        {
            ...
            {
                List<Node> bestPath = GetNearestWalkablePathAroundBuilding(startPosition, targetNode,
                    targetGridObject.Size.x, targetGridObject.Size.y);
                if (bestPath == null)
                {
        ...
        private List<Node> GetNearestWalkablePathAroundBuilding(Vector3 startPosition, Node targetNode,
